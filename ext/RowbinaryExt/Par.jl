...
function parse_type(::Type{T}, data::Vector{UInt8}, offset::Int) where T
    ...
    elseif T <: RowbinaryTypes.DateTime64
    ...
    elseif T <: RowbinaryTypes.NanoDate64
        timestamp = reinterpret(Int64, data[offset:offset+7])[1]
    ...
    elseif typeof(T) == Union && RowbinaryTypes.union_has_nothing(T)
