...
function serialize_type(value::T, _type::Type = T) where T
    ...
    elseif _type <: RowbinaryTypes.DateTime64
    ...
    elseif _type <: RowbinaryTypes.NanoDate64
        precision = _type.parameters[1]
    ...
    elseif _type <: RowbinaryTypes.Decimal32
        return reinterpret(UInt8, [value.value])
    elseif _type <: RowbinaryTypes.Decimal64
        return reinterpret(UInt8, [value.value])
    elseif _type <: RowbinaryTypes.Decimal128
        return reinterpret(UInt8, [value.value])
    elseif _type == UUID
    ...
    elseif _type <: Dict
        ...
        return vcat(size_bytes, content)
    elseif typeof(_type) == Union && RowbinaryTypes.union_has_nothing(_type)
        if isnothing(value)
