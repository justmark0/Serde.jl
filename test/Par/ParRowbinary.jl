...
@testset verbose = true "ParRowbinary" begin
    ...
    @testset "Case №4: Special Types" begin
        ...
        @test ParRowbinary.float64(parsed.decimal32) == 123.45
        @test ParRowbinary.float64(parsed.decimal64) == 12345.678
        @test ParRowbinary.float64(parsed.decimal128) == 123456789.1234
